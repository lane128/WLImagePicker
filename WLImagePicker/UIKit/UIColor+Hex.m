...
+ (UIColor *)mb_colorWithHexString:(NSString *)color {
    return [self mb_colorWithHexString:color alpha:1.0f];
}
...
UIColor *mb_colorWithHexString(NSString *str) {
    return [UIColor mb_colorWithHexString:str];
}

UIColor *mb_colorWithHexAndAlpha(NSString *str, CGFloat alpha) {
    return [UIColor mb_colorWithHexString:str alpha:alpha];
}
